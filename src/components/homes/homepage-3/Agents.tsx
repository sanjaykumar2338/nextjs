    ...
    return (
        <div className="section-agents">
            <div className="tf-container">
                <div className="wrap-box-agents tf-spacing-1">
                        ...
                        <div className="col-lg-4">
                            <div className="box">
                                ...
                                <div className="content mb_32">
                                    <h6 className="mb_12">
                                        Total Sales Volume: $48M+ in Closed
                                        Sales
                                    </h6>
                                    <p className="text-body-2">
                                        With over a decade of real estate
                                        experience in luxury coastal properties,
                                        Jessica is known for her integrity, deep
                                        market knowledge.
                                    </p>
                                </div>
                                <a
